...
export function getDensity (svg,pts_ary,segment_num = 5000){
  ...
  */
  ...
  let dictAllmin3Q= [];
  let dictAllmin4Q= [];
  let overall_minRadius = 500,overall_maxRadius = 0


  for (var index = 0; index < segment_num/4; index++) {
    var result;
    result = minCircle(index, new_pts)
    if(result[0]<overall_minRadius){
      overall_minRadius = result[0]
    }
    if(result[0]>overall_maxRadius){
      overall_maxRadius = result[0]
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  */
    ...
    return [dictAllmin,segPolyList,strPath,path.getTotalLength(),overall_minRadius,overall_maxRadius];
