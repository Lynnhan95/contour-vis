...
export function hoMo (segment_ary,belt_ary,pts_inside_ary,value){
  ...
  for (var i = 0; i <pts_inside_ary.length ; i++) {
    ...
    var dstCorners =  [
    belt_ary[index][3][0],belt_ary[index][3][1],
    belt_ary[index][2][0], belt_ary[index][2][1],
    belt_ary[index][1][0], belt_ary[index][1][1], 
    belt_ary[index][0][0],belt_ary[index][0][1], 
