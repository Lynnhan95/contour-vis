...
const slidingBins =71// make sure it is an odd number
const segNumbY = 40
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                let [circleAry,segPolyList,strPath,pathLen,minR,maxR] = getDensity(select("#myCanvas"),simplifiedAreaProjected,setSegNumb)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        if (prevState.subSegList !== this.state.subSegList) {
            ...
            var [transformPts,transObj] = hoMo(this.state.newSegPolyList,this.state.beltSegList,slicePts_in_Seg,segNumbY)
            console.log(transObj);

            var [densityGroup, areGroup] = insideCounter(this.state.subSegList, this.state.beltCellList,transformPts,setSegNumb,this.state.segNumbY,slidingBins,2,this.state.pathLen,this.state.minmaxR)
