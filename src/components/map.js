    ...
    componentDidUpdate(prevPros, prevState){
        ...
        if(prevState.currGeoData !== this.state.currGeoData){
            ...
            // if (d.properties.name === '湖南'){
                ...
                _me.state.simplifiedOutContours = _me.getOuterBoundaryContours(simplifiedArea, 3)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                segPolyList.forEach((d,i) => {
                  let newSegPoly = getNewSeg(d, clip_boundary,i)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                // create new outsegList by clipping from out polygon

                // let clip_outBoundary = this.outerBoundaryCoordinates[0].map((d) => {
                //     return this.autoProjection(d)
                // })
                // let newOutSegPolyList = [] 
                // segPolyList.forEach((d,i) => {
                //     let newOutSegPoly = getNewSeg(d, clip_outBoundary, i)

                //     newOutSegPolyList.push(newOutSegPoly)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
            create subsegments from outSegment
*/
                // let outsubSegList = []
                // newOutSegPolyList.forEach((d,i) => {
